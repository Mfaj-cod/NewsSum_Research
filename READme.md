...
```bash
python prompted_eval.py --model <google/flan-t5-xl or any model>  --data data/processed/newsumm_processed.json  --out_dir results/<model>_evaluation
```
